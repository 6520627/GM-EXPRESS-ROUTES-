...
export default function Services() {
  return (
    <section id="services" className="py-20 bg-neutral-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-primary-black mb-4 font-montserrat">
            Our Services
          </h2>
          <p className="text-xl text-neutral-gray font-roboto max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-primary-black mb-4 font-montserrat">
                {service.title}
              </h3>
              <p className="text-neutral-gray font-roboto">
                {service.description}
              </p>
              <motion.div
